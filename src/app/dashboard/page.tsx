    ...
    <div className="bg-surface text-on-surface min-h-screen flex flex-col overflow-x-hidden">
      ...
      <div className="flex pt-16 h-screen overflow-hidden">
        <aside className="hidden md:flex flex-col h-full w-64 p-4 space-y-2 bg-[#f2f4f6] dark:bg-slate-900 font-inter text-sm font-medium">
          ...
          {/* General - Link về trang Dashboard chính */}
          <Link
            href="/dashboard"
            className="bg-[#e0e3e5] dark:bg-slate-800 text-[#031635] dark:text-[#3afea0] rounded-xl font-bold p-3 flex items-center gap-3 cursor-pointer active:opacity-80 transition-all"
          >
            <span
          ...
          <Link
            ...
            className="text-slate-600 dark:text-slate-400 p-3 flex items-center gap-3 hover:bg-[#e0e3e5] dark:hover:bg-slate-800 transition-all cursor-pointer active:opacity-80"
          >
