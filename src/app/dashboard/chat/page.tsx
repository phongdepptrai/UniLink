...
// ⚡ Bolt: Cache Intl.DateTimeFormat instance at module level to avoid costly
// re-instantiations inside the formatTime function which is called for every message
